...
/**
 * The banner itself, drawn.
 *
 * Split from the fetch above so the CMS preview pane can mount this exact
 * component over an unsaved draft. Pure and synchronous; the caller decides
 * which banner it is looking at.
 */
export function BannerView({ banner }: { banner: CmsBanner }) {
